...
library(hexbin)
library(vsn)
setwd("/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/")
...
setwd("/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/GSE107934_RAW")
...
gene_id_mapping_from_uniprot <- as.data.frame(
  read_delim("/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/support/gene_id_mapping_from_uniprot.tab", 
...
write_csv(to_write, 
          file = "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/data/count_df_vsn.csv")
write_csv(targets, "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/support/targets.csv")
```
...
write_csv(ttop_B_vs_AT.1h, 
          file = "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/data/ttop_B_vs_AT.1h.csv") #no diff
write_csv(ttop_B_vs_AT.4h, 
          file = "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/data/ttop_B_vs_AT.4h.csv")
write_csv(ttop_AT.1h_vs_AT.4h, 
          file = "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/data/ttop_AT.1h_vs_AT.4h.csv")
write_csv(ttop_B_vs_RT.1h, 
          file = "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/data/ttop_B_vs_RT.1h.csv") #no diff
write_csv(ttop_B_vs_RT.4h, 
          file = "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/data/ttop_B_vs_RT.4h.csv") #high
write_csv(ttop_RT.1h_vs_RT.4h, 
          file = "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/data/ttop_RT.1h_vs_RT.4h.csv")
```
...
write_csv(PathwayActivity_CARNIVALinput_B_vs_AT.1h, 
    "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/Results/PathwayActivity_CARNIVALinput_B_vs_AT.1h.csv")
```
...
write_csv(PathwayActivity_CARNIVALinput_B_vs_AT.4h, 
    "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/Results/PathwayActivity_CARNIVALinput_B_vs_AT.4h.csv")
```
...
write_csv(PathwayActivity_CARNIVALinput_B_vs_RT.4h, 
    "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/Results/PathwayActivity_CARNIVALinput_B_vs_RT.4h.csv")
```
...
Normalised_counts_dorothea <- read_csv("/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/data/count_df_vsn.csv")
Experimental_design_dorothea <- read_csv("/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/support/targets.csv")
# ttop_B_vs_AT.4h_dorothea = ttop_B_vs_AT.4h
# ttop_B_vs_RT.4h_dorothea = ttop_B_vs_RT.4h
ttop_B_vs_AT.4h_dorothea <- read_csv("/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/data/ttop_B_vs_AT.4h.csv")
ttop_B_vs_RT.4h_dorothea <- read_csv("/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/data/ttop_B_vs_RT.4h.csv")
```
...
write_csv(tf_activities_CARNIVALinput_AT.4h_vs_b, "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/Results/TFActivity_CARNIVALinput_AT4h_vs_B.csv")
```
...
tf_activities_CARNIVALinput_RT.4h_vs_b<- tf_activities_stat_B_vs_RT.4h %>%
    as.data.frame() %>% 
    tibble::rownames_to_column(var = "TF") 
write_csv(tf_activities_CARNIVALinput_RT.4h_vs_b, "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/Results/TFActivity_CARNIVALinput_RT4h_vs_B.csv")
```
...
source("~/Desktop/BPKWorkStudy/CARNIVAL/transcriptutorial-master_dickinson/scripts/assignPROGENyScores.r")
source("~/Desktop/BPKWorkStudy/CARNIVAL/transcriptutorial-master_dickinson/scripts/generateTFList.r")
...
#save SIF
write_tsv(sif, "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/Results/omnipath_carnival.tsv")
...
progenylist = assignPROGENyScores(progeny = t(PathwayActivity_carnival), 
                                            ...
                                            id = "gene", 
                                            access_idx = 1)
saveRDS(progenylist, "/Users/luna/Desktop/BPKWorkStudy/CARNIVAL/Results/myProgenyList.rds")
```
...
carnival_result = runCARNIVAL( inputObj= upstream_inputs_filtered, 
                               ...
                               solverPath = "/Users/luna/Desktop/CPLEX_Studio2211/cplex/bin/x86-64_osx/cplex",
                               solver = "cplex",
                               timelimit=50000,
                               betaWeight = 0)
